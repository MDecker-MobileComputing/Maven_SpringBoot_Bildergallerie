...
public class DateiUploadController {
     ...
     */
    @PostMapping("/bild")
    public String bildHochladen( @RequestParam(value = "bild"    , required = true  ) MultipartFile bild,
                                 @RequestParam(value = "titel"   , required = false ) String        titel,
                                 @RequestParam(value = "tagWerte", required = false ) List<String>  tagWerte,
        ...
        LOG.info( "Checkboxen mit Tags ausgewählt: " + tagWerte );
        ...
        try {
            ...
            try {
                ...
                final BildEntity bildEntity = 
                		_bildService.bildHochladen( titelNormal, byteArray, tagWerte ); // throws BildSchonVorhandenException
